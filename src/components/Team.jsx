      ...
      <div className="fluid-container container-team">
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>V Vishesh <br /><span>Chief Curator</span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Ambika Biswas Neela <br /><span>Associate Director of Operations</span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Soumik Hazra <br /><span>Director of Finance</span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Jissnu <br /><span>Video & Production Lead</span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Samridho Saha <br /><span>Chief Designer</span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
      ...
      <div className="fluid-container container-team">
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Divas Gupta <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Satyam Shorya Jha <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Anurag Singh<br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Hemanth Sanagavarapu <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Aniket Panigrahi <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Sukanya Dutta <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Anshika Chaudhary<br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Vishal Jaiswal<br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Sivaji Naidu<br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <Slide to bottom>
          <div className="card">
            ...
            <div className="content">
              <div className="contentBx">
                <h3>Sammanita Singh <br /><span></span></h3>
              </div>
              <ul className="sci">
                <li>
                  <a href="#"><i className="fa fa-instagram" aria-hidden="true"></i></a>
