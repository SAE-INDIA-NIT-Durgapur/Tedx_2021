...
const Sponsors = () => {
  return (
    ...
    //                 <h1 style={{ color: 'red' }}>Gift Partner</h1><br />
    ...
    //                 </div>
    //                 <h1 style={{ color: 'red' }}> Self Care Partner</h1><br />
    //                 <div className="column-sponsors">
    ...
    //                 </div>
    //                 <h1 style={{ color: 'red' }}>Insurance Partner</h1><br />
    //                 <div className="column-sponsors">
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    ...
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                 </div>
    //                 <h1 style={{ color: 'red' }}>Friend</h1><br />
    //                 <div className="column-sponsors">
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second2" />
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
    //                 </div>
    //                 <h1 style={{ color: 'red' }}>Promoter</h1><br />
    //                 <div className="column-sponsors">
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second2" />
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
    ...
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
    //                 </div>
    //                 <h1 style={{ color: 'red' }}>Digital Media Partner</h1><br />
    //                 <div className="column-sponsors">
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second2" />
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
    ...
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
    //                 </div>
    //                 <h1 style={{ color: 'red' }}>Radio Partner</h1><br />
    //                 <div className="column-sponsors">
    //                     <img src={img1} classname="sponsors-img" alt="second" />
    //                     <img src={img1} classname="sponsors-img" alt="second2" />
    //                     <img src={img1} classname="sponsors-img" alt="second3" />
